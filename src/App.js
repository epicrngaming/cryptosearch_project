    ...
    <div style={{ backgroundColor: "crimson", minHeight: "100vh" }} className="App">
      ...
      <div className="d-flex justify-content-center">
        <div className="col-md-4 mt-5">
          <input type="text" className="form-control" value={crypto} onChange={(e) => setCrypto(e.target.value)} placeholder="Enter the cryptocurreny in small case letter" required />
        </div>
      </div>
